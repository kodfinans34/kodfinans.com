                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-5 text-foreground/30 text-sm font-medium leading-relaxed">
                            <p>
                                <strong className="text-foreground/70">KodFinans.com</strong>, Türkiye&apos;nin en kapsamlı dijital kod bozum ve oyun ürünleri platformudur. Steam Cüzdan Kodu, Razer Gold, iTunes, Google Play ve diğer dijital varlıklarınızı anında nakite çevirebilir, aynı zamanda en güncel oyun kodlarını güvenle satın alabilirsiniz.
                            </p>
                            <p>
                                Kurumsal müşterilerimize özel <strong className="text-foreground/70">VIP Finans</strong> programı ile piyasa ortalamasının üzerinde oranlar sunar, öncelikli işlem garantisi sağlarız. İster bireysel oyuncu, ister toplu işlem yapan bayi olun — KodFinans her ölçekte hizmet verir.
                            </p>
                            <p>
